...
import { EditButtonForBlock, UserEditButtonForBlock, DeleteButtonForBlock } from '../../components/ButtonForBlock'
              ...
              <tr key={todi.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-800 dark:text-white">
                ...
                <td className="p-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <UserEditButtonForBlock href={`/block/todi/useredit?id=${todi.id}`} />
                    <Link href={`/block/todi/view?id=${todi.id}`} className="text-blue-600 hover:underline">View</Link>
