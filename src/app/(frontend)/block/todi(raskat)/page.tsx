...
import { EditButtonForBlock ,DeleteButtonForBlock, UserEditButtonForBlock} from '../../components/ButtonForBlock'
              ...
              <tr key={todi.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-800 dark:text-white">
                ...
                <div className="flex items-center space-x-2">
                  <EditButtonForBlock href={`/block/todi(raskat)/edit?id=${todi.id}`} />
                   <UserEditButtonForBlock href={`/block/todi(raskat)/useredit?id=${todi.id}`} />
                  <Link href={`/block/todi(raskat)/view?id=${todi.id}`} className="text-blue-600 ml-2 hover:underline">View</Link>
